...
pdf_path = r"C:\Users\chane\Downloads\Eye Tracking Participant Images.pdf"
...
output_folder = r'C:\Users\chane\Desktop\HITS\HITS\Eye Tracking Participant Images'
for i, image in enumerate(images, start=0):
    image.save(f'{output_folder}/eyetracking_{i}.png', 'PNG')
