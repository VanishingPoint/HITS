...
pdf_path = r"C:\Users\chane\Downloads\Main Menu Proctor Images.pdf"
...
output_folder = r'C:\Users\chane\Desktop\HITS\HITS\Main Menu Proctor Images'
for i, image in enumerate(images, start=0):
    image.save(f'{output_folder}/menu_{i}.png', 'PNG')
