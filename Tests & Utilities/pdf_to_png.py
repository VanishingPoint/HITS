...
pdf_path = r"C:\Users\chane\Downloads\Eye Tracking Proctor Images-1.pdf"
...
output_folder = r'C:\Users\chane\Desktop\HITS\HITS\Eye Tracking\Eye Tracking Proctor Images'

for i, image in enumerate(images, start=0):
    image.save(f'{output_folder}/eyetracking_proctor_page_{i}.png', 'PNG')
